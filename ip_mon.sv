class ip_mon extends uvm_monitor;
    ...
    virtual if_fifo.ip_mon_mod intrf;
    ...
    task run_phase(uvm_phase phase);
        ...
        begin
            ...
            `uvm_info(get_type_name(),$sformat("[%0t]: IP_MON: WR_CS=%0d RD_CS=%0d WR_EN=%0d RD_EN=%0d DATA_IN=%0d",my_seq_item.wr_cs,my_seq_item.rd_cs,my_seq_item.wr_en,my_seq_item.rd_en,my_seq_item.data_in),UVM_MEDIUM);
        end
    endtask
